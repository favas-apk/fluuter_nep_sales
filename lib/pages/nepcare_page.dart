...
class _MyPageState extends State<NepCarePage> {
  ...
  Future<void> _read_nepcare() async {
    ...
    var response = await ApiServices().readNepcare(
        "neptongl_staff",
    ...
    if (response.statusCode == 200) {
      ...
      if (result == 1) {
        ...
        _details_closed =
            DetailsClosed.fromJson(jsonResponse["details_closed"][0]);

        _details_other =
            DetailsOther.fromJson(jsonResponse["details_others"][0]);
      }
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    ...
                    _details_closed == null
                        ? '0'
                        : (int.parse(_details_closed!.cn!) +
                                int.parse(_details_closed!.cs!) +
                                int.parse(_details_closed!.cp!))
                            .toString(),
                    style: TextStyle(
                        fontWeight: FontWeight.bold, color: Colors.black),
                  )),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    ...
                    _details_other == null
                        ? "0"
                        : (int.parse(_details_other!.wn!) +
                                int.parse(_details_other!.ws!) +
                                int.parse(_details_other!.wp!))
                            .toString(),
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, color: Colors.black),
                  )),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    ...
                    _details_other == null
                        ? "0"
                        : (int.parse(_details_other!.dn!) +
                                int.parse(_details_other!.ds!) +
                                int.parse(_details_other!.dp!))
                            .toString(),
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, color: Colors.black),
                  )),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    ...
                    _details_other == null
                        ? "0"
                        : (int.parse(_details_other!.ln!) +
                                int.parse(_details_other!.ls!) +
                                int.parse(_details_other!.lp!))
                            .toString(),
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, color: Colors.black),
                  )),
